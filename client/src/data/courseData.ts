...
function makeVocabulary(week: number, session: number, vocabulary: TopicVocabulary[]): VocabularyWord[] {
  return vocabulary.map(([hanzi, pinyin, meaning, partOfSpeech], index) => {
    const audioAssetId = getVocabularyAudioAssetId(week, hanzi);
    return {
...
export const audioManifest = lessons.map((lesson) => ({
  ...
  rights: lesson.listening.audioSrc ? "Tạo gốc cho Hoa Ngữ 180 Ngày." : "Kịch bản gốc đã biên soạn; clip audio tệp đang chờ sản xuất. Ứng dụng không tự thay bằng giọng đọc mặc định của thiết bị.",
}));

const externalVideoSources: Record<number, NonNullable<VideoContext["externalSource"]>> = {
  1: { provider: "youtube", videoId: "-Lsvve4JCIA", sourceUrl: "https://www.youtube.com/watch?v=-Lsvve4JCIA", embedUrl: "https://www.youtube-nocookie.com/embed/-Lsvve4JCIA?rel=0&playsinline=1", channel: "Everyday Chinese", sourceTitle: "Learn Chinese All Pinyin Tones in 10 Minutes", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video riêng về bốn thanh và thanh nhẹ; dùng làm tham khảo ngoài cho luyện phát âm." },
  2: { provider: "youtube", videoId: "TaNktqkbQ2M", sourceUrl: "https://www.youtube.com/watch?v=TaNktqkbQ2M", embedUrl: "https://www.youtube-nocookie.com/embed/TaNktqkbQ2M?rel=0&playsinline=1", channel: "Learn Chinese with ChineseClass101.com", sourceTitle: "SELF INTRODUCTION | How to Introduce Yourself in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video tự giới thiệu, khớp tình huống chào hỏi và nói tên tuần này." },
  3: { provider: "youtube", videoId: "V4RHLgdnFBo", sourceUrl: "https://www.youtube.com/watch?v=V4RHLgdnFBo", embedUrl: "https://www.youtube-nocookie.com/embed/V4RHLgdnFBo?rel=0&playsinline=1", channel: "Harbin Mandarin", sourceTitle: "Telling Time in Mandarin Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Dạy hỏi và trả lời giờ, phù hợp mẫu hẹn gặp theo giờ." },
  4: { provider: "youtube", videoId: "vc3-FL_UgAI", sourceUrl: "https://www.youtube.com/watch?v=vc3-FL_UgAI", embedUrl: "https://www.youtube-nocookie.com/embed/vc3-FL_UgAI?rel=0&playsinline=1", channel: "Learn Chinese with ChineseClass101.com", sourceTitle: "Introducing Your Family Members in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video giới thiệu thành viên gia đình, trùng bối cảnh của bài." },
  5: { provider: "youtube", videoId: "4N33a-_OpJw", sourceUrl: "https://www.youtube.com/watch?v=4N33a-_OpJw", embedUrl: "https://www.youtube-nocookie.com/embed/4N33a-_OpJw?rel=0&playsinline=1", channel: "jiayouchinese", sourceTitle: "Slow Chinese Vlog | My Morning Routine", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Vlog chậm về dậy, ăn sáng và chuẩn bị buổi sáng." },
  6: { provider: "youtube", videoId: "PvlqjXZew2c", sourceUrl: "https://www.youtube.com/watch?v=PvlqjXZew2c", embedUrl: "https://www.youtube-nocookie.com/embed/PvlqjXZew2c?rel=0&playsinline=1", channel: "Learn Chinese Online", sourceTitle: "First Day at Work Chinese Conversation", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Hội thoại ngày đầu đi làm, hỗ trợ phần từ/câu công việc của chủ đề học và làm." },
  7: { provider: "youtube", videoId: "SIEC4vUvrP0", sourceUrl: "https://www.youtube.com/watch?v=SIEC4vUvrP0", embedUrl: "https://www.youtube-nocookie.com/embed/SIEC4vUvrP0?rel=0&playsinline=1", channel: "Everyday Chinese", sourceTitle: "How to Order Food at a Restaurant in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Hội thoại gọi món nhà hàng, đúng chủ đề ăn uống của bài." },
  8: { provider: "youtube", videoId: "7QbMyl-v7-Q", sourceUrl: "https://www.youtube.com/watch?v=7QbMyl-v7-Q", embedUrl: "https://www.youtube-nocookie.com/embed/7QbMyl-v7-Q?rel=0&playsinline=1", channel: "Emily Chinese", sourceTitle: "How to Speak Chinese at a Clothing Store", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Hội thoại tại cửa hàng quần áo, phù hợp hỏi giá và số lượng." },
  9: { provider: "youtube", videoId: "T-5g7zfL70c", sourceUrl: "https://www.youtube.com/watch?v=T-5g7zfL70c", embedUrl: "https://www.youtube-nocookie.com/embed/T-5g7zfL70c?rel=0&playsinline=1", channel: "Everyday Chinese", sourceTitle: "Talk about the weather in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video nói trực tiếp về thời tiết, làm nền cho câu mưa/lạnh và chọn quần áo." },
  10: { provider: "youtube", videoId: "vuBPZfTgctQ", sourceUrl: "https://www.youtube.com/watch?v=vuBPZfTgctQ", embedUrl: "https://www.youtube-nocookie.com/embed/vuBPZfTgctQ?rel=0&playsinline=1", channel: "Harbin Mandarin", sourceTitle: "Learn Hobbies in Mandarin Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Từ vựng hoạt động yêu thích hỗ trợ nói về sở thích và cuối tuần." },
  11: { provider: "youtube", videoId: "capURhR1Lw0", sourceUrl: "https://www.youtube.com/watch?v=capURhR1Lw0", embedUrl: "https://www.youtube-nocookie.com/embed/capURhR1Lw0?rel=0&playsinline=1", channel: "Hello Mandarin", sourceTitle: "Learn Chinese: At the Doctor – Explaining Symptoms", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Học liệu ngôn ngữ về mô tả triệu chứng nhẹ; không thay thế tư vấn y khoa." },
  12: { provider: "youtube", videoId: "Swo_xtB2Z8M", sourceUrl: "https://www.youtube.com/watch?v=Swo_xtB2Z8M", embedUrl: "https://www.youtube-nocookie.com/embed/Swo_xtB2Z8M?rel=0&playsinline=1", channel: "Comfy Chinese by Vika", sourceTitle: "Asking Directions in Mandarin Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video hỏi đường trong tiếng Hoa, khớp mẫu đến ga tàu điện." },
  13: { provider: "youtube", videoId: "L_aMsM8e-1Y", sourceUrl: "https://www.youtube.com/watch?v=L_aMsM8e-1Y", embedUrl: "https://www.youtube-nocookie.com/embed/L_aMsM8e-1Y?rel=0&playsinline=1", channel: "Everyday Chinese", sourceTitle: "Check in & Out at a Hotel in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Hội thoại check-in/check-out khách sạn, đúng ngữ cảnh đặt và ở phòng." },
  14: { provider: "youtube", videoId: "hvptjdMvnxY", sourceUrl: "https://www.youtube.com/watch?v=hvptjdMvnxY", embedUrl: "https://www.youtube-nocookie.com/embed/hvptjdMvnxY?rel=0&playsinline=1", channel: "Chinese with Mandarin HQ", sourceTitle: "Talking About a Travel Experience in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Nói về trải nghiệm du lịch, phù hợp cấu trúc đã từng với 过." },
  15: { provider: "youtube", videoId: "u8UBzEs6PuY", sourceUrl: "https://www.youtube.com/watch?v=u8UBzEs6PuY", embedUrl: "https://www.youtube-nocookie.com/embed/u8UBzEs6PuY?rel=0&playsinline=1", channel: "ChinesePod", sourceTitle: "How to Say ‘I Can Speak Chinese’ in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video luyện nói có thể nói tiếng Hoa, tương ứng cấu trúc 会." },
  16: { provider: "youtube", videoId: "zjNk6BBprgE", sourceUrl: "https://www.youtube.com/watch?v=zjNk6BBprgE", embedUrl: "https://www.youtube-nocookie.com/embed/zjNk6BBprgE?rel=0&playsinline=1", channel: "Harbin Mandarin", sourceTitle: "How to Compare People and Things Using Bi", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Dạy so sánh bằng 比, trùng trọng tâm ngữ pháp của bài." },
  17: { provider: "youtube", videoId: "iQQjO8wUMJ0", sourceUrl: "https://www.youtube.com/watch?v=iQQjO8wUMJ0", embedUrl: "https://www.youtube-nocookie.com/embed/iQQjO8wUMJ0?rel=0&playsinline=1", channel: "Chilling Chinese", sourceTitle: "Differences in 看到，看完，看好", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Giải thích nhóm bổ ngữ kết quả, có ví dụ 看好 phù hợp bài." },
  18: { provider: "youtube", videoId: "RfP8c454_Cs", sourceUrl: "https://www.youtube.com/watch?v=RfP8c454_Cs", embedUrl: "https://www.youtube-nocookie.com/embed/RfP8c454_Cs?rel=0&playsinline=1", channel: "Global Chinese Learning Platform", sourceTitle: "How to use 如果……就…… in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video về cấu trúc nếu…thì…, đúng phần điều kiện của bài." },
  19: { provider: "youtube", videoId: "1Pg1xwRyl7U", sourceUrl: "https://www.youtube.com/watch?v=1Pg1xwRyl7U", embedUrl: "https://www.youtube-nocookie.com/embed/1Pg1xwRyl7U?rel=0&playsinline=1", channel: "Learn Chinese with Pipo", sourceTitle: "Taking the Bus | HSK 1–2 Listening Practice", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Có tình huống đi nhầm xe buýt, tương ứng sự cố thường ngày của bài." },
  20: { provider: "youtube", videoId: "A-oPzWRqtDw", sourceUrl: "https://www.youtube.com/watch?v=A-oPzWRqtDw", embedUrl: "https://www.youtube-nocookie.com/embed/A-oPzWRqtDw?rel=0&playsinline=1", channel: "ShuoshuoChinese 说说中文", sourceTitle: "Talk About Daily Activities in Chinese", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Video mô tả hoạt động trong ngày, giúp luyện trình tự kể chuyện." },
  21: { provider: "youtube", videoId: "bFcy4GfN8Zg", sourceUrl: "https://www.youtube.com/watch?v=bFcy4GfN8Zg", embedUrl: "https://www.youtube-nocookie.com/embed/bFcy4GfN8Zg?rel=0&playsinline=1", channel: "Everyday Chinese", sourceTitle: "Efficient Training of Chinese Listening | HSK 3 Listening Practice", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Bài luyện nghe cấp HSK3; dùng để luyện rút thông tin chính, không thay câu hỏi nội bộ." },
  22: { provider: "youtube", videoId: "pIOJgAa4ua8", sourceUrl: "https://www.youtube.com/watch?v=pIOJgAa4ua8", embedUrl: "https://www.youtube-nocookie.com/embed/pIOJgAa4ua8?rel=0&playsinline=1", channel: "Talk Jiyue", sourceTitle: "HSK 3 Reading Section 1 Step-by-step Tutorial", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Hướng dẫn từng bước phần đọc HSK3, phù hợp kỹ năng tìm ý chính." },
  23: { provider: "youtube", videoId: "yTZMYsg5-4Y", sourceUrl: "https://www.youtube.com/watch?v=yTZMYsg5-4Y", embedUrl: "https://www.youtube-nocookie.com/embed/yTZMYsg5-4Y?rel=0&playsinline=1", channel: "The highs and Luos | Christina 罗缇娜", sourceTitle: "How to pass HSK 3! | HSK 3 study tips", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Mẹo học HSK3 dùng cho bước chọn điểm yếu và lập cách ôn tiếp theo." },
  24: { provider: "youtube", videoId: "fc7I4PVYrII", sourceUrl: "https://www.youtube.com/watch?v=fc7I4PVYrII", embedUrl: "https://www.youtube-nocookie.com/embed/fc7I4PVYrII?rel=0&playsinline=1", channel: "Language Endeavor", sourceTitle: "HSK 3 test paper 1 | H31001 | HSK3 model paper", display: "external-link", specificity: "specific-video", checkedAt: "2026-08-27", note: "Một đề mô phỏng HSK3 xác định; liên kết mở thẳng video thay vì playlist." },
};
...
export const videoManifest: VideoContext[] = activeTopicSeeds.map((seed, index) => {
  ...
  return {
    ...
    externalSource: externalVideoSources[week],
  };
});
